...
/**
 * Fair Comparison: Both use 100K rows at once
 * Shows pure IPC overhead difference (no batch count advantage)
 */
public class FairComparisonBenchmark {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("\n" + repeat("=", 100));
        System.out.println("Fair Comparison: Both Use 100K Rows at Once (Same Batch Size)");
        ...
        System.out.println("\nBoth methods process " + TOTAL_ROWS + " rows in ONE batch");
        System.out.println("This isolates pure IPC overhead (no batch count difference)");

        System.out.println("\n" + repeat("-", 100));
        System.out.printf("%-12s %-20s %15s %15s %12s%n",
                         "Scenario", "Description", "Cross (100k×1)", "Embed (100k×1)", "Speedup");
        System.out.println(repeat("-", 100));
        ...
        for (String[] scenario : scenarios) {
            ...
            // Cross-process: 100K at once
            long crossStart = System.nanoTime();
            benchmarkArrowSocket(allStrings, allDoubles, udf);
            long crossTime = System.nanoTime() - crossStart;

            stopPythonWorker();

            // Embedded: 100K at once
        ...
        System.out.println("\nThis speedup comes purely from:");
        System.out.println("  1. No Arrow serialization (Java side)");
        System.out.println("  2. No Socket IPC");
        System.out.println("  3. No Arrow deserialization (Python side)");
        System.out.println("  4. Zero-copy data access (for numerics)");
